<?php
// Hospital Portal Sidebar Include
// Shows only: Dashboard, Inventory, Donors, Appointments, Blood Requests, Analytics, Logout
...
<aside class="ss-sidebar">
    <div class="ss-header">
        <a class="ss-logo" href="<?php echo $base; ?>/hospital/index.php">
